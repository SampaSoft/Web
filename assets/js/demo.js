...
demo = {
    ...
    initDashboardPageCharts: function() {
        ...
        var dataMuni = {
            labels: ['9:00', '12:00', '15:00', '18:00', '21:00', '00:00', '3:00', '6:00'],
            series: [
                [300, 490, 500, 677, 690, 550,350, 220, 175, 110, 50, 55],
                [67, 152, 143, 240, 287, 110, 40, 50, 60, 55, 23, 12]
            ]
        };
        ...
        var data = {
            ...
            series: [
                [542, 670, 575, 780, 553, 453, 326, 434, 568, 320, 100, 151]
            ]
        };
    ...
    initGoogleMaps: function() {
        var myLatlng = new google.maps.LatLng(-23.5506938,-46.6417462);
        var mapOptions = {
            zoom: 18,
            center: myLatlng,
